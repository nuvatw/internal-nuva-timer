...
exports.awardSessionCompletion = awardSessionCompletion;
...
async function awardSessionCompletion(userId, durationMinutes) {
    ...
    const xpGained = (0, game_1.calculateXpGain)(durationMinutes, dailyMinBefore);
    const newTomatoes = (0, game_1.calculateNewTomatoes)(durationMinutes, dailyMinBefore);
    ...
    return {
        ...
        total_xp: newTotalXp,
        current_level: newLevel,
        level_title: (0, game_1.getLevelTitle)(newLevel),
